...
export function AssistantChat({
  ...
  return (
    <div className="as-chat">
      ...
      <style>{`
        .as-thinking{display:inline-flex;align-items:center;gap:6px;font-weight:600;color:var(--chart-2);background:linear-gradient(90deg,rgba(255, 82, 0,.10),rgba(255, 82, 0,.20),rgba(255, 82, 0,.10));background-size:200% 100%;animation:asShimmer 1.3s linear infinite}
        @keyframes asShimmer{0%{background-position:200% 0}100%{background-position:-200% 0}}
        .as-think-spin{width:13px;height:13px;border:2px solid rgba(255, 82, 0,.35);border-top-color:var(--chart-2);border-radius:50%;display:inline-block;animation:asSpin .7s linear infinite}
